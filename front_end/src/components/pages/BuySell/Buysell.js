...
const BuySell = () => {
  ...
  const [formData, setFormData] = useState({ energy: "", price: "", distance: "" });
    ...
    <div className={`buy-sell-container ${transactionType} bg-[#faf9fa73] `}>
      ...
      <div className="buy-sell-section">
        ...
        <form className="transaction-form" onSubmit={handleSubmit}>
          <label>
            {transactionType === "buy" ? "Energy Required (kWh):" : "Energy For Sell (kWh):"}
            <input
              type="number"
              name="energy"
              value={formData.energy}
              onChange={handleInputChange}
              placeholder={`Enter ${transactionType === "buy" ? "amount to buy" : "energy to sell"}`}
            />
          ...
          <label>
            ...
            <input
              ...
              onChange={handleInputChange}
              placeholder={`Enter ${transactionType === "buy" ? "max price" : "selling price"}`}
            />
      ...
      {showModal && (
        <div className="modal-overlay">
          <div className="modal">
            <h3>Successful!</h3>
            <p>
              You have successfully {transactionType === "buy" ? "bought" : "sold"} energy.
            </p>
